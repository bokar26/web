/**
 * Audit logging service for Shipping Plans Execution
 * Writes audit logs to public.audit_logs table
 */
...
export async function listAuditLogs(
  ...
  if (error) {
    console.error('[shipping/listAuditLogs] Failed to list audit logs:', error)
