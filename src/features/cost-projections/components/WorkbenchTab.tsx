...
import { EditAssumptionsDialog } from "./EditAssumptionsDialog"
...
export function WorkbenchTab({ scope, onEditAssumptions, kpiData }: WorkbenchTabProps) {
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">
                  ${(kpis.totalProjectedCost / 1000000).toFixed(1)}M
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{kpis.costAccuracy}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{kpis.riskLevel}</p>
              </div>
            </div>
          </CardContent>
        </Card>
