    ...
    <section className="relative min-h-screen flex flex-col justify-start pt-4 md:pt-6 overflow-hidden">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 md:py-6">
        ...
        <div className="mx-auto max-w-5xl text-center space-y-6 relative z-10">
          ...
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-mint-50 border border-mint-200 mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-ink-900 dark:text-ink-50 leading-tight">
            {headline}
          </h1>
          ...
          <div className="pt-16 relative">
            <div className="border-2 border-emerald-300 dark:border-emerald-600 rounded-lg p-8 relative mx-auto max-w-5xl">
              {/* Border break with text */}
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-white dark:bg-ink-900 px-4">
              ...
              <div className="flex items-center justify-center gap-16 text-2xl">
                <div className="text-center">
                  <Link 
                    ...
                    prefetch
                    className="text-ink-900 dark:text-ink-50 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors font-bold block"
                  >
                    Procurement
                  </Link>
                  <p className="text-sm text-ink-700 dark:text-ink-300 mt-2">AI procurement tools</p>
                </div>
                <div className="text-center">
                  <Link 
                  ...
                  <p className="text-sm text-ink-700 dark:text-ink-300 mt-2">Shorten cash conversion cycles</p>
                </div>
                <div className="text-center">
                  <Link 
                  ...
                  <p className="text-sm text-ink-700 dark:text-ink-300 mt-2">Predictive logistics insights</p>
                </div>
                <div className="text-center">
                  <Link 
                  ...
                  <p className="text-sm text-ink-700 dark:text-ink-300 mt-2">Actionable supply insights</p>
                </div>
              </div>
            </div>
          </div>
