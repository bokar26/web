  ...
  return (
    <div className="dashboard-bg min-h-screen p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-300">Balance stock levels with AI-driven demand forecasts and optimize working capital</p>
      </div>
          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-4">
              {inventoryPlans.map((plan) => (
                <div key={plan.sku} className="flex items-center justify-between p-3 rounded-lg bg-gray-800/50">
              ...
              {inventoryPlans.map((plan) => (
                <div key={plan.sku} className="p-4 rounded-lg border border-gray-600 hover:border-gray-500 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm mb-3">
                    ...
                    <div>
                      <div className="text-gray-400 mb-1">Forecasted Demand</div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-400">Reorder Date:</span>
                      <span className="text-white">{plan.reorderDate}</span>
                    </div>
                    <div className="text-right">
                      <div className="text-gray-400">Qty to Reorder</div>
          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-green-900/20 border border-green-500/30">
                ...
                <div className="text-xs text-gray-400">Through optimized inventory levels</div>
              </div>
