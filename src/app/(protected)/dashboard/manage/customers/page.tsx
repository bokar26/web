...
export default function CustomersPage() {
  ...
  const getHealthIcon = (health: string) => {
    switch (health) {
      ...
      default:
        return <Users className="w-4 h-4 text-gray-600 dark:text-white" />;
    }
  };
    ...
    <div className="dashboard-bg min-h-screen p-6">
      ...
      <Card className="dashboard-card p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-sm text-white">SLA Compliance</div>
        </div>
            ...
            <div
              ...
              className={`p-4 rounded-lg border cursor-pointer transition-colors ${
                selectedCustomer?.name === customer.name 
                  ? 'bg-gray-900 dark:bg-gray-900 border-green-500 dark:border-green-500' 
                  : 'bg-gray-800 dark:bg-gray-900 border-gray-600 dark:border-gray-800 hover:bg-gray-700 dark:hover:bg-gray-800'
              }`}
              onClick={() => setSelectedCustomer(customer)}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-900 dark:bg-gray-900 text-white font-bold text-sm">
                    {index + 1}
                  </div>
                  <div>
              ...
              {/* Health Bar */}
              <div className="mt-3">
                <div className="w-full bg-gray-900 dark:bg-gray-900 rounded-full h-2">
                  <div 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="dashboard-card p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button variant="outline" className="text-white dark:text-white border-gray-600 dark:border-gray-200 dark:border-gray-800">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-gray-800/50 dark:bg-gray-900/50">
                  <div className="text-sm text-gray-600 dark:text-white mb-1">On-Time Delivery</div>
                  <div className="text-2xl font-bold text-white">{selectedCustomer.otdPercent}%</div>
                </div>
                <div className="p-3 rounded-lg bg-gray-800/50 dark:bg-gray-900/50">
                  <div className="text-sm text-gray-600 dark:text-white mb-1">Fill Rate</div>
                  <div className="text-2xl font-bold text-white">{selectedCustomer.fillRate}%</div>
                </div>
              </div>

              <div className="p-4 rounded-lg bg-gray-800/50 dark:bg-gray-900/50">
                <div className="text-sm text-gray-600 dark:text-white mb-2">SLA Compliance</div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-lg font-bold text-white">{selectedCustomer.slaCompliance}%</span>
                  <span className="text-sm text-gray-600 dark:text-white">Target: 95%</span>
                </div>
                <div className="w-full bg-gray-900 dark:bg-gray-900 rounded-full h-2">
                  <div 
                    className={`h-2 rounded-full ${
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-gray-800/50 dark:bg-gray-900/50">
                  <div className="text-sm text-gray-600 dark:text-white mb-1">Recent Orders</div>
                  <div className="text-lg font-bold text-white">{selectedCustomer.recentOrders}</div>
                </div>
                <div className="p-3 rounded-lg bg-gray-800/50 dark:bg-gray-900/50">
                  <div className="text-sm text-gray-600 dark:text-white mb-1">Revenue</div>
          ...
          <Card className="dashboard-card p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-gray-800/50 dark:bg-gray-900/50">
                ...
                <div className="text-xs text-gray-600 dark:text-white">Last 30 days</div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-gray-800/50 dark:bg-gray-900/50">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600 dark:text-white">Order #12345</span>
                    <span className="text-green-400">Delivered</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600 dark:text-white">Order #12346</span>
                    <span className="text-blue-400">In Transit</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600 dark:text-white">Order #12347</span>
              ...
              <div className="p-4 rounded-lg bg-gray-800/50 dark:bg-gray-900/50">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600 dark:text-white">4.2/5</span>
                </div>
              </div>
            </div>
          </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
        <Card className="dashboard-card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-600 dark:text-white">Total Customers</span>
          </div>
        ...
        <Card className="dashboard-card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-600 dark:text-white">Avg SLA Compliance</span>
          </div>
        ...
        <Card className="dashboard-card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-600 dark:text-white">Avg OTD</span>
          </div>
          <div className="text-2xl font-bold text-white mb-1">
        ...
        <Card className="dashboard-card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-600 dark:text-white">At-Risk Customers</span>
          </div>
          <div className="text-2xl font-bold text-white mb-1">
            {customerMetrics.filter(c => c.health === 'at-risk').length}
          </div>
          <div className="text-sm text-gray-600 dark:text-white">Require attention</div>
        </Card>
      </div>
    </div>
  );
